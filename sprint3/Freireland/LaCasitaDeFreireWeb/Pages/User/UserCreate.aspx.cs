...
namespace LaCasitaDeFreireWeb.Pages.User
{
    public partial class UserCreate : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                u = new Users(txtNameUser.Text.Trim(), txtPassword.Text.Trim(), txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtSecondLastName.Text.Trim(), int.Parse(txtCellphone.Text.Trim()), char.Parse(rdbGender.Text.Trim()), txtEmail.Text.Trim(), txtCI.Text.Trim(), cmbRol.Text.Trim());
