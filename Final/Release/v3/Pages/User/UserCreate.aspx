<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserCreate.aspx.cs" Inherits="LaCasitaDeFreireWeb.Pages.User.UserCreate" %>
                ...
                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-12 col-sm-4">
                                        ...
                                        <asp:DropDownList ID="cmbRol" runat="server" CssClass="form-control" placeholder="Rol">
                                            <asp:ListItem Text="Seleccione Rol" Value=""></asp:ListItem>
                                            <asp:ListItem Text="Administrador" Value="Administrador"></asp:ListItem>
                                            <asp:ListItem Text="Secretari@" Value="Secretaria"></asp:ListItem>
                                            <asp:ListItem Text="Director" Value="Director"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Label ID="lblRolError" runat="server" CssClass="error-message" style="color: red;" Visible="false"></asp:Label>
                                    </div>
                                </div>
                                    </div>
                    ...
                    <div class="card-footer bg-dark text-white">
                        <div class="d-grid gap-2">
                            ...
                            <a class="btn btn-outline-secondary" href="UserIndex.aspx">Cancel</a>
                        </div>
              </div>
