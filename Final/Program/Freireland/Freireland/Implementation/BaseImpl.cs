...
namespace Freireland.Implementation
{
    public class BaseImpl
    {
       //string connectionString = @"Server=VALEROJAS\VALERIA;Database=dbInstitution;User Id = sa; Password=vale123;";
        ...
        string connectionString = @"workstation id=dbInstitution.mssql.somee.com;packet size=4096;user id=figue_SQLLogin_1;pwd=ta9zt9kh8h;data source=dbInstitution.mssql.somee.com;persist security info=False;initial catalog=dbInstitution";
        ...
        public List<SqlCommand> CreateNBasicCommand(List<string> sql)
        {
            List<SqlCommand> commands = new List<SqlCommand>();
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand command;
