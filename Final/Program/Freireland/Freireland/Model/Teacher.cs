...
namespace Freireland.Model
{
    public class Teachers: Person
    {
        ...
        public Teachers(short id, string firstName, string lastName, string secondLastName, string phone, string cI, char gender, string placeOfBirth, string address, DateTime birthdate, byte status, DateTime registerDate, DateTime lastUpdate, short userID)
